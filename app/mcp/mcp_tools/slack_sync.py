    ...
    def on_created(self, event):
        ...
        if mcp_data.get("type") == "rca_report":
            ...
            blocks = [
                {
                    "type": "header",
                    "text": {"type": "plain_text", "text": f"🛠️ RCA Report for Incident #{incident_id}"}
                },
                {
                    "type": "section",
                    "fields": [
                ...
                },
                {
                    "type": "context",
                    "elements": [
                        {"type": "mrkdwn", "text": "🔎 _Generated by PowerOps RCA Agent_"}
                    ]
                }
            ]

            send_to_slack(blocks, is_block=True)
            print(f"✅ Sent Slack block notification for file: {event.src_path}")
...
def run_slack_sync():
    ...
    observer.start()
    print("📡 Slack MCP Tool is running...")
